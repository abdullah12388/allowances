...
$(function () {
    ...
    document.getElementById('resetBtn').addEventListener('click', function () {
        document.getElementById('interval_start').value = document.getElementById('rec_date').value;
...
$("#allowancesToolbar")
    .find("select")
    .change(function () {
        var filename = document.getElementById('allowancesExportFileName').value;
...
document.getElementById("allowances_print_selected").addEventListener("click", function () {
    var selectedRows = [];
...
// var x = $("#allowancesDetailsTbl");
// $("#allowancesDetailsToolbar")
//     .find("select")
//     .change(function () {
//         var filename = document.getElementById('allowancesDetailsExportFileName').value;
//         var currentDate = new Date();
...
// document.getElementById("allowances_details_print_selected").addEventListener("click", function () {
//     var selectedRows = [];
