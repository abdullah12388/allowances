$(function () {
    $.ajax({
        url: "/tank/delivery/current/table/data/api/",
        method: "GET",
        dataType: "json",
        success: function (t) {
            // console.log(t);
...
document.getElementById("print_selected").addEventListener("click", function () {
    var selectedRows = [];
    selectedRows = $("#currentDeliveryTbl").bootstrapTable("getSelections");
    console.log(selectedRows);
    var printWindow = window.open("", "_blank");
    var currentDate = new Date();
    printWindow.document.open();
    printWindow.document.write(
        "<html><head><title>Current Deliveries Table</title>" +
        "<style>" +
    ...
    var columnNames = [];
    $("#currentDeliveryTbl thead th").each(function () {
