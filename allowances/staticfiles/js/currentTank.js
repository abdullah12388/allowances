$(function () {
    $.ajax({
        url: "/tank/tank/current/table/data/api/",
        method: "GET",
        dataType: "json",
        success: function (t) {
            // console.log(t);
    ...
    .change(function () {
        ...
        o.bootstrapTable("destroy").bootstrapTable({
            ...
            columns: [
                ...
                { field: "volume", title: "Product Volume" },
...
document.getElementById("print_selected").addEventListener("click", function () {
    var selectedRows = [];
    selectedRows = $("#currentTanksTbl").bootstrapTable("getSelections");
    console.log(selectedRows);
    var printWindow = window.open("", "_blank");
    var currentDate = new Date();
    printWindow.document.open();
    printWindow.document.write(
        "<html><head><title>Current Tanks Table</title>" +
        "<style>" +
    ...
    var columnNames = [];
    $("#currentTanksTbl thead th").each(function () {
